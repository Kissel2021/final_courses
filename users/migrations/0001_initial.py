    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shipping_method', models.CharField(blank=True, choices=[('nova_poshta', 'Нова Пошта'), ('ukrposhta', 'Укрпошта'), ('meest', 'Meest Express'), ('pickup', 'Самовывоз'), ('courier', 'Курьер'), ('international', 'Международная почта')], max_length=50, null=True)),
                ('shipping_location', models.CharField(blank=True, max_length=128, null=True)),
